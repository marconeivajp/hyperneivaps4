...
void salvarConfiguracao() {
    ...
    cfg.lCurv = listCurvature; cfg.lZmCtr = listZoomCentro; cfg.nSl = numSlotsPadrao;
...
void carregarConfiguracao() {
    ...
    if (f) {
        ...
        if (lidos >= 1) {
            ...
            if (lidos >= sizeof(LayoutConfig)) numSlotsPadrao = cfg.nSl; else if (numSlotsPadrao <= 0) numSlotsPadrao = 7;
            ...
            // VERIFICA SE EXISTE CONFIGURA��O DA GRADE SALVA
